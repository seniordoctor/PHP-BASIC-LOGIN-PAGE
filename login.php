...
<body class="<?= !cook('color') ? 'bg-dark' : cook('color') ?>">
<div class="d-flex align-items-center justify-content-center p-4"><img height="" src="tltlogo.png" alt=""></div>
<div  class="container d-flex align-items-center justify-content-center">
    <div class="card <?= !cook('color') ? 'bg-dark' : cook('color') ?>" style="width: 18rem;">
        <div class="card-header bg-primary">
            Giriş Yap
        </div>
        <div class="card-body">
            <!-- ALERT KISMI SADECE BİR UYARI OLDUĞUNDA ÇALIŞACAKTIR -->
            ...
            <form action="islem.php?islem=giris" method="post">
                ...
                <!-- YANLIŞ GİRİNCE KULLANICI ADI RESETLENMESİNİ session('username & password') ile kalıcı yaptık -->
