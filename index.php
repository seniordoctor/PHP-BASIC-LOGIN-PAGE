    ...
    <div class="card bg-dark" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            if (get('islem') == 'true'){
                ...
                echo "<div class='alert alert-danger'>İşlem başarısız, tekrar deneyin</div>";
            }

            ?>

            <form action="islem.php?islem=hakkimda" method="post">
                <textarea class="form-control bg-dark text-light" name="hakkimda" id="" cols="30" rows="10"><?= html_entity_decode($hakkimda); ?></textarea>
